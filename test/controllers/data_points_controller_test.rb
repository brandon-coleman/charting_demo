...
class DataPointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_point" do
    assert_difference("DataPoint.count") do
      post data_points_url, params: { data_point: { timestamp: @data_point.timestamp, value: @data_point.value } }
    end
  ...
  test "should update data_point" do
    patch data_point_url(@data_point), params: { data_point: { timestamp: @data_point.timestamp, value: @data_point.value } }
